...
def main():
    ...
    channel.basic_consume(queue='deneme', on_message_callback = callback ,auto_ack=False, exclusive=True) #auto ack otomatik onay       exclusive burada kuyruğa başka biri bağlanamaz diyor True ile bağlanmasını engelliyoruz 
