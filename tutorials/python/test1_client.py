...
def main():
    ...
    url= pika.URLParameters("amqp://test1:test1@ulakmq.tzty.net:5672/%2f/")
    ...
    channel.basic_consume(queue='hello', on_message_callback = callback ,auto_ack=False) #auto ack otomatik onay 
